...
- [02. Arquitectura General](academico/02_arquitectura_general.md)
- [03. Modelo SOREL-20M](academico/03_modelo_sorel20m.md)
- [04. Sistema Híbrido Multicapa](academico/04_sistema_hibrido_multicapa.md)
- [05. Hallazgos Multicapa](academico/05_hallazgo_multicapa.md)
- [06. XAI y Explicabilidad LLM](academico/06_xai_explicabilidad.md)
- [07. Métricas y Resultados](academico/07_metricas_y_resultados.md)
- [08. Comparación ML vs Híbrido](academico/08_comparacion_ml_vs_hibrido.md)
- [09. Pruebas Unitarias](academico/09_pruebas_unitarias.md)
- [10. Pruebas de Integración](academico/10_pruebas_integracion.md)
- [11. Análisis Sample1](academico/11_analisis_sample1.md)
...
- [Guía General del Frontend](frontend/FrontendGuide.md)
- [Especificación Frontend V2](frontend/Frontv2.md)

### 6. `docs/pruebas_y_reportes/` — Tests E2E y Reportes
- [Guía de Pruebas E2E](pruebas_y_reportes/TEST_E2E.md)
- [Flujo de Pruebas (Test Flow)](pruebas_y_reportes/test-flow.md)
- [Reporte de Demostración](pruebas_y_reportes/demo-reporte.md)

### 7. `docs/assets/` — Recursos Gráficos
- Logotipos, diagramas e imágenes vectoriales del proyecto.
