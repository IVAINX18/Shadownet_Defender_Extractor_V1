...
echo ""
echo -e "  ${CYAN}Siguiente paso (opcional):${NC} Exponer Ollama públicamente con un túnel HTTPS (por ejemplo, ngrok)."
echo -e "  Configura la URL pública resultante en la variable OLLAMA_BASE_URL (terminando en /v1) si necesitas acceso remoto."
echo ""
